...
import { ApplicationMode, APPLICATION_MODE, getAppModeDisplayName, getPlatformSupportedApplicationModes } from "./components/applicationModes";
...
const getCanvasComponent = (mode: ApplicationMode) => <Visual3DCanvas mode={mode} />;
